...
**Status:** Accepted for Phase 8.2 M0; Phase 8.3 U0-U1 implemented through 25 August 2026
...
- `verify` runs backend protocol acceptance, the backend-owned security harness, and packaged production-console browser journeys;
- `package` embeds the UI artifact in the runnable REST artifact under classpath `ui/`, served at `/ui/*`;
