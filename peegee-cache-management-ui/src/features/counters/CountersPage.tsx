...
export function CountersPage({ canOperate, client, selectedSetupId }: { readonly canOperate: boolean; readonly client: CounterClientPort; readonly selectedSetupId?: string }) {
  ...
  const adjust = () => { if (selectedSetupId !== undefined && active !== undefined) void commit(() => client.adjustCounter(selectedSetupId, active.encodedNamespace, active.encodedKey, active.version, { delta, createIfMissing: false, ttlMode: 'PRESERVE_EXISTING', ttlMillis: null }), 'Counter adjusted'); };
