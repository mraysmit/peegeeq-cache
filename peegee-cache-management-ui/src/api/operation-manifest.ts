...
export const operationManifest: readonly OperationClassification[] = [
  ...
  ...classify('entries', 'VIEW', ['listEntries', 'getEntry', 'checkEntryExists']),
  ...
  ...classify('locks', 'REVEAL', ['revealLockOwner', 'checkLockOwnership']),
  ...classify('locks', 'OPERATE', ['forceReleaseLock', 'acquireLock', 'renewLock', 'releaseLock']),
  ...
  ...classify('monitoring', 'VIEW', ['getDatabaseMonitoring', 'getRuntimeMonitoring', 'getCacheMetrics']),
