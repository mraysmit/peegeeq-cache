...
class ManagementOverviewBrowserIT {
    ...
    @ManagementBrowserScenario(id = "PW-OVERVIEW-003", requirement = "Management API: overview reports setup health from the real database", area = ManagementBrowserArea.OVERVIEW, risk = ManagementBrowserRisk.CRITICAL, action = "Inspect Setup status on the seeded overview", expectedResult = "The setup health is Up", cleanup = "Close the scoped context and reset PostgreSQL", operations = {"getOverview"}, evidence = {ManagementBrowserEvidence.VISIBLE_RESULT, ManagementBrowserEvidence.HTTP_OPERATION, ManagementBrowserEvidence.DATABASE, ManagementBrowserEvidence.RESOURCE_CLEANUP})
    @Test
    void overviewReportsSetupUp() throws Exception {
        overview(context -> assertThat(metric(context.page(), "Setup status")).containsText("Up"));
    }

    @ManagementBrowserScenario(id = "PW-OVERVIEW-004", requirement = "UI design: overview distinguishes health latency from status", area = ManagementBrowserArea.OVERVIEW, risk = ManagementBrowserRisk.MEDIUM, action = "Inspect the Setup status detail", expectedResult = "Round-trip latency is presented in milliseconds", cleanup = "Close the scoped context and reset PostgreSQL", operations = {"getOverview"}, evidence = {ManagementBrowserEvidence.VISIBLE_RESULT, ManagementBrowserEvidence.HTTP_OPERATION, ManagementBrowserEvidence.DATABASE, ManagementBrowserEvidence.RESOURCE_CLEANUP})
    @Test
    ...
    @ManagementBrowserScenario(id = "PW-OVERVIEW-009", requirement = "Management API: available schema storage is formatted as bytes", area = ManagementBrowserArea.OVERVIEW, risk = ManagementBrowserRisk.HIGH, action = "Inspect Cache schema storage", expectedResult = "A non-zero binary byte value is visible rather than Unavailable", cleanup = "Close the scoped context and reset PostgreSQL", operations = {"getOverview"}, evidence = {ManagementBrowserEvidence.VISIBLE_RESULT, ManagementBrowserEvidence.HTTP_OPERATION, ManagementBrowserEvidence.DATABASE, ManagementBrowserEvidence.RESOURCE_CLEANUP})
    @Test
